...
class pc30_l6 : public cSimpleModule
{
  private:
    int snode;
  protected:
...
Define_Module(pc30_l6);

void pc30_l6::initialize()
{
    snode = par("Snode");
...
void pc30_l6::handleMessage(cMessage *msg)
{
...
packet30 *pc30_l6 :: generateMessage (){
    int dnode = par("Dnode");
...
void pc30_l6 :: forwardMessage (packet30 *msg){
    int n = gateSize("gate");
